const NFT = artifacts.require("../contracts/FractionalNFT");
const Token = artifacts.require("../contracts/FractionalNFTToken");
...
module.exports = async function (callback) {
    ...
    //sends tokens to these 3 wallets simulating other users wallets
